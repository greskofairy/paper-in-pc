...
// Implementation of iLSHADE-RSP

/*
Authors: Vladimir Stanovov, Shakhnaz  Akhmedova, Eugene Semenkin
Implementation of LSHADE-RSP for CEC 2018 competition
CEC 2017/18 competition websites:
http://www.ntu.edu.sg/home/epnsugan/index_files/CEC2018/CEC2018.htm
*/
#include <cmath>
#include <time.h>
#include <iomanip>
...
public:
    ...
    double** Popul;  // �ެѬ��ڬ� �լݬ� ��Ѭ��ڬ�
    double** PopulTemp;
    double* FitMass;  // �٬߬Ѭ�֬߬ڬ� ���߬ܬ�ڬ� ���ڬԬ�լ߬����
    double* FitMassTemp;
    double* FitMassCopy;
    double* BestInd;  // �ݬ���֬� �߬Ѭ۬լ֬߬߬�� ��֬�֬߬ڬ�
    int* Indexes;
    double** Archive;
    double* FitMassArch;
    ...
    double Right;  // �Ӭ֬��߬�� �Ԭ�Ѭ߬ڬ��
    double Left;   // �߬ڬج߬�� �Ԭ�Ѭ߬ڬ��
